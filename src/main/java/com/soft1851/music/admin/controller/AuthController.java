 ...
 */
@RestController
@RequestMapping(value = "/api/oauth2/code/github")
@Slf4j
public class AuthController {
    ...
    public void getUser(@RequestParam("code") String code) {
        ...
        try {
            ...
            list.add(new BasicNameValuePair("client_id", "aea8d673b6cabe74c012"));
            list.add(new BasicNameValuePair("client_secret", "bf10d3a1b86395ee271361bac1f8bf12dacfdacf"));
            ...
            //解决response中文乱码问题
            response.sendRedirect("http://localhost:8088/#/githubLogin?user=" + URLEncoder.encode(user, "UTF-8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
